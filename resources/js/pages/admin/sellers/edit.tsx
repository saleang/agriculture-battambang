...
export default function EditSeller({ seller }: Props) {
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        location_district: seller.seller?.location_district,
    ...
    return (
        <AppLayout>
            <Head title={`Edit Seller - ${seller.seller?.farm_name}`} />
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-slate-900">Edit Seller</h1>
                                <p className="text-slate-600 mt-2">Update seller information for {seller.seller?.farm_name}</p>
                            </div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="relative max-w-xs">
                                        ...
                                        <select
                                            ...
                                            className="w-full pl-11 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 focus:bg-white transition-all cursor-pointer appearance-none"
                                        >
                            ...
                            <div className="p-8 border-b border-slate-200 bg-amber-50/30">
                                ...
                                <div className="mb-6 flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                    ...
                                    <p className="text-sm text-blue-800">
                                        Only fill out these fields if you want to change the seller's password. Otherwise, leave them blank.
                                    </p>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all"
                                                placeholder="••••••••"
                                            />
                                        </div>
                                    </div>
