        ...
        foreach ($unrespondedOrders as $order) {
            try {
                $order->update([
                    ...
                    'cancellation_reason' => ' អ្នកលក់មិនបានឆ្លើយតបសម្រាប់ការបញ្ជាទិញទេ។ ការបញ្ជាទិញត្រូវបានបោះបង់ដោយស្វ័យប្រវត្តិបន្ទាប់ពី 30 នាទី។',
                ]);
        ...
        foreach ($unpaidOrders as $order) {
            try {
                $order->update([
                    ...
                    'cancelled_at' => now(),
                    'cancelled_by' => Order::CANCELLED_BY_SYSTEM,
                    'cancellation_reason' => 'អ្នកបានខកខានការបង់ប្រាក់។ ការបញ្ជាទិញត្រូវបានបោះបង់ដោយស្វ័យប្រវត្តិក្នុងកំឡុងពេល 30 នាទី បន្ទាប់ពីអ្នកលក់បានយល់ព្រមការបញ្ជាទិញរបស់ក្នុង។',
                ]);
