...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::delete('users/{user}', [UserManagementController::class, 'destroy'])->name('users.destroy');// // User Management Routes
        // Route::get('users', [UserManagementController::class, 'index'])->name('users.index');
        // Route::get('users/create', [UserManagementController::class, 'create'])->name('users.create');
        // Route::post('users', [UserManagementController::class, 'store'])->name('users.store');
        // Route::get('users/{user}/edit', [UserManagementController::class, 'edit'])->name('users.edit');
    ...
    Route::middleware(['role:seller'])->prefix('seller')->name('seller.')->group(function () {
        ...
        Route::get('/villages/{communeId}', [SellerProfileController::class, 'getVillages'])->name('villages.get');// Product Routes
