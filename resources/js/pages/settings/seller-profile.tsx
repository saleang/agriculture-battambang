                    ...
                    >
                        {({ processing, recentlySuccessful, errors }) => (
                            <>
                                <div className="space-y-6">
                                    ...
                                    <div className="grid gap-6 md:grid-cols-2">
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            />
                                            <InputError className="mt-1" message={errors.location_district} />
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            defaultValue={seller.payment_qr_code ?? ''}
                                            name="payment_qr_code"
                                            placeholder="Enter payment QR code URL (optional)"
                                        />
                                ...
                                <div className="flex items-center gap-4">
                                    <Button variant="default" disabled={processing} data-test="update-seller-profile-button">
                                        Save Changes
                                    </Button>
